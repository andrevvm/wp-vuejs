<?php
  ...
  function load_vue_scripts() {
    vue_load_style('app.css', '/assets/css/app.css', false, null);
    vue_load_script('manifest.js', '/assets/js/manifest.js', true);
    vue_load_script('vendor.js', '/assets/js/vendor.js', true);
    vue_load_script('app.js', '/assets/js/app.js', true);
  }
